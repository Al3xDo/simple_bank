...
// Source: github.com/Al3xDo/simple_bank/db/sqlc (interfaces: Store)
...
// ListEntriess mocks base method.
func (m *MockStore) ListEntriess(arg0 context.Context, arg1 db.ListEntriessParams) ([]db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListEntriess", arg0, arg1)
	ret0, _ := ret[0].([]db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListEntriess indicates an expected call of ListEntriess.
func (mr *MockStoreMockRecorder) ListEntriess(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListEntriess", reflect.TypeOf((*MockStore)(nil).ListEntriess), arg0, arg1)
}
